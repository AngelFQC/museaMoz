region = new museaMoz.Region('Callao');
	...
	provincia = new museaMoz.Provincia('Callao');
      ...
      museo.keywordFlickr = 'museo+de+bomberos+peru';
      ...
      museo.keywordFlickr = 'museo+submarino+abtao';
      ...
      museo.keywordFlickr = 'museo+real+felipe+callao';
      ...
      museo.keywordFlickr = 'museo+naval+callao';
