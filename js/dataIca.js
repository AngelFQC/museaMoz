region = new museaMoz.Region('Ica');
	...
	provincia = new museaMoz.Provincia('Ica');
      ...
      museo.keywordFlickr = 'museo+regional+ica';
	...
	provincia = new museaMoz.Provincia('Nasca');
      ...
      museo.keywordFlickr = 'museo+maria+reiche';
      ...
      museo.keywordFlickr = 'museo+antonini+nazca';
	...
	provincia = new museaMoz.Provincia('Pisco');
      ...
      museo.keywordFlickr = 'museo+tambo+colorado';
      ...
      museo.keywordFlickr = 'museo+paracas+tello';
