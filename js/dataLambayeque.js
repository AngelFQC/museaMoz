region = new museaMoz.Region('Lambayeque');
	...
	provincia = new museaMoz.Provincia('Chiclayo');
      ...
      museo.keywordFlickr = 'museo+zaña';
      ...
      museo.keywordFlickr = 'museo+huaca+rajada';
	...
	provincia = new museaMoz.Provincia('Ferreñafe');
      ...
      museo.keywordFlickr = 'museo+sican';
	...
	provincia = new museaMoz.Provincia('Lambayeque');
      ...
      museo.keywordFlickr = 'museo+bruning+lambayeque';
      ...
      museo.keywordFlickr = 'museo+huaca+chotuna';
      ...
      museo.keywordFlickr = 'museo+sitio+tucume';
      ...
      museo.keywordFlickr = 'museo+tumbas+reales+sipan';
			museo.addAtencion('Martes a domingo', '09:00 - 17:00');
